...
CREATE TABLE `consumo_materia_prima` (
  ...
  `id_detalle_plan` int(10) UNSIGNED NOT NULL,
  `id_materia_prima` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `detalle_receta` (
  `id_detalle_receta` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `inventario_producto_terminado` (
  `id_inv_producto` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `lotes` (
  ...
  `id_materia_prima` int(10) UNSIGNED DEFAULT NULL,
...
--
ALTER TABLE `detalle_plan_produccion`
  MODIFY `id_detalle_plan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `detalle_receta`
--
ALTER TABLE `detalle_receta`
  MODIFY `id_detalle_receta` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `inventario_producto_terminado`
  MODIFY `id_inv_producto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `materias_primas`
  MODIFY `id_materia_prima` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `unidades_medida`
  MODIFY `id_unidad` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
